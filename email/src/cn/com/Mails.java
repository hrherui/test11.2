...
public class Mails {
    ...
    // 发件人的 邮箱 和 密码（替换为自己的邮箱和密码）
	 public static String myEmailAccount = "hr1432391788@163.com";
	    public static String myEmailPassword = "15760158017";
	    ...
	    // 收件人邮箱（替换为自己知道的有效邮箱）
	    public static String receiveMailAccount = "1432391788@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("C://Users//ASUS//Pictures//Camera//Roll//1.jpg")); // 读取本地文件
...
//        text.setContent("这是一张图片<br/><img src='cid:image_fairy_tail'/>", "text/html;charset=UTF-8");
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("src/www.html"));  // 读取本地文件
